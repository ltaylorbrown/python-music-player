...
class Interface:
    ...
    def _search_tracks(self):
        ...
        if choice == "t":
            found = (self.music_library.search('title', search))
            self._list_tracks(found)
        elif choice == "a":
            found = (self.music_library.search('artist', search))
            self._list_tracks(found)
        elif choice == "f":
            found = (self.music_library.search('file', search))
            self._list_tracks(found)
        elif choice == "*":
            found = self.music_library.search('any', search)
            self._list_tracks(found)
        else:
